...
export async function ClientAccountSwitcher({
  currentSlug,
  basePath,
}: {
  currentSlug: string;
  ...
  return (
    <div className="mb-6 flex flex-wrap items-center gap-2 rounded-xl border border-[var(--linea)] bg-black/20 p-3 text-sm">
