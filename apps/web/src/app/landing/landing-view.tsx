/**
 * El landing público, como componente.
 *
 * Vive aparte de su `page.tsx` porque **lo renderizan dos rutas**: `/landing`,
 * que es su URL propia, y `/` cuando quien llega no tiene sesión. Esa segunda
 * es la que importa — quien teclee la dirección del producto ve la cara de
 * venta, no un error ni un directorio de clientes.
 *
 * No trata datos ni resultados sellados, así que se puede servir a cualquiera.
 */
