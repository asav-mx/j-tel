...
**Lee `ENMIENDAS.md` primero: manda sobre este archivo, sobre `CLAUDE.md` y sobre `readme.md`.** Trae lo que Asav cambió después de exportar el skill (el color de ruta, lo que la landing promete, las direcciones de ontoy.app) y las reglas que este repo ya tiene y que el skill no sabe.
