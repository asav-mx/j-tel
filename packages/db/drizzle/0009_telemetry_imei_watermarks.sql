CREATE TABLE IF NOT EXISTS "telemetry_imei_watermarks" (
...
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "telemetry_imei_watermarks_carrier_imei_idx" ON "telemetry_imei_watermarks" USING btree ("carrier_account_id","imei");
