...
- **Número de licencia** (obligatorio) y **su vencimiento** (si la licencia lo trae; la regla del §4 de la ficha vieja gobierna cómo se juzga).
...
| Actividad | Unidades que ha operado · pasos por parada (Pieza 9.2) | **aún no disponible · llega con la asignación y con la terminal de circuitos** |
...
4. «Piden atención» del tablero incluye choferes con papeles vencidos o faltantes.
