...
**9.8b La parada tiene ficha, no expediente.** Se abre tocándola —`Ver ‹parada›`— y muestra su nombre, su ubicación, su tabla prometida por franja, lo medido y su demanda. Tres límites, y ninguno es negociable:

- **No es sujeto con expediente.** Sigue siendo parte del circuito (9.8): tener ficha no es tener expediente.
- **No lleva papeles.** Los permisos y los derechos de vía viven en la **concesión**; una parada no tiene cajón de documentos.
- **Nunca recibe veredicto propio.** Lo medido en una parada es **el cumplimiento del circuito en esa parada**, dicho con esas palabras y en el vocabulario de la etapa 1 —«se sostuvo», «se agujeró», «sin datos» (9.3)—: **sin sello hasta que exista el árbitro del 9.12.**
