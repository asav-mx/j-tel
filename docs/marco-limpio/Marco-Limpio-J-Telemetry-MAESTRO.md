...
> ✎ **22-sep-2026 (ASAV) — enmienda a la 8.8, en dos renglones de arriba. Los renglones se conservan tal cual; esto los enmienda, no los reemplaza.**
>
> 1. **El «hilo» se llama «Paradas».** Donde el renglón del Mapa dice «tocar una ruta abre su **hilo**», léase **abre sus paradas**. Lo que hace no cambia —la ruta como una línea, con sus paradas, sus camiones y dónde está el pasajero—; cambia cómo se nombra. «Hilo» era una metáfora que sólo entiende quien la inventó, y el pasajero que abre su ruta busca sus paradas. El nombre se cambió **también en el código**, a propósito: un nombre viejo que sobrevive en el código es el que se cuela de vuelta a la pantalla en el siguiente cambio.
> 2. **A la lista completa de rutas se llega por «Ir a», no desde el Mapa.** Donde el renglón del Mapa dice «desde el Mapa se llega a la lista completa de rutas publicadas», léase **desde «Ir a»**. Se llegaba por dos caminos —una ficha en el Mapa y el lugar «Ir a»—, y dos caminos a la misma pantalla obligan al pasajero a preguntarse si son la misma. El Mapa vuelve a ser sólo el mapa. La 8.10 se sigue cumpliendo: la lista tiene su salida de regreso arriba, que ahora devuelve a la búsqueda.
>
