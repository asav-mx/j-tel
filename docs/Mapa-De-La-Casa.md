...
- **Expedientes** — el segundo afluente: pólizas, permisos, exámenes, capacitaciones, mantenimiento firmado, inspecciones. Aquí viven los **choferes** (hoy toda su sustancia son sus papeles; se gradúan a cuarto propio cuando ganen vida operativa). *(nuevo — construible ya, no depende del GPS)*
...
- **Cuentas y demos** — altas de carrier y cliente, demos que se vuelven contrato, servicio operado.
