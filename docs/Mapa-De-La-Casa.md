...
- **Lectores** — los lectores de boletos de Ontoy: el inventario de **toda la plataforma** en una sola lista, agrupado en EN UNIDAD · EN BODEGA · MUDO, con los de baja al final. Aquí sólo se da de alta —pegando la llave que el aparato enseña, con su huella de seis caracteres para comparar a ojo—; montar, soltar y dar de baja se hacen en **Ver ‹lector›**, que es el expediente de su sustantivo. Va en esta casa y no en la del transportista —donde viven los GPS— porque la pregunta que contesta es la de J-Staff: si la plataforma está sana. **Mudo** se cuenta en horas de servicio del circuito (4 h, provisional hasta medir), y un lector cuya unidad no tiene circuito **no se juzga**: su ficha dice que no se puede decir. *(nuevo, 23 sep 2026; su familia de formas —cajas con muesca— entró al skill el mismo día)*
