...
3. **Los cuatro grupos del inventario, no «sin señal»:** `Todos` · `Desconectados` · `En unidad` · `En bodega`, que no se enciman y suman el total; los de baja plegados al final, fuera de los chips. «Sin señal» es estado de unidad (15 min), no de dispositivo. «Piden atención» se lleva los desconectados. Y también **los de bodega que nunca reportaron**: un aparato comprado que nunca ha dicho una palabra es justo lo que alguien necesita ver (el 005). Lo que lo distingue no es el silencio —en bodega todos callan, y el 006 y el 007 esperan camión— sino que **nunca reportó**. Sigue en `En bodega` con su cuadro hueco; en «Piden atención» lleva la etiqueta «nunca reportó», que el cuarto ya usaba. Ni el skill ni el Marco se tocan: «desconectado» sigue siendo montado y más de 24 h callado. Un aparato recién dado de alta que nadie ha prendido también entra, y es correcto: se compró y nadie lo ha probado. Quién entra lo dice la base al leer, no esta ficha.
